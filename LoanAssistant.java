...
public class LoanAssistant extends JFrame {
    ...
    public LoanAssistant() {
    	...
    	balanceTextField.addActionListener(new ActionListener()
    	{
    		...
    		{
    			balanceTextFieldActionPerformed(ae);
    		}
    	});
    	...
    	interestTextField.addActionListener(new ActionListener()
    	{
    		public void actionPerformed(ActionEvent ae)
    		{
    			interestTextFieldActionPerformed(ae);
    		}
    	});
    	...
    	monthsTextField.addActionListener(new ActionListener()
    	{
    		public void actionPerformed(ActionEvent ae)
    		{
    			monthsTextFieldActionPerformed(ae);
    		}
    	});
    	...
    	interestTextField.addActionListener(new ActionListener()
    	{
    		public void actionPerformed(ActionEvent ae)
    		{
    			paymentTextFieldActionPerformed(ae);
    		}
    	});
    	...
    	computeButton.addActionListener(new ActionListener()
    	{
    		public void actionPerformed(ActionEvent ae)
    		{
    			computeButtonActionPerformed(ae);
    		}
    	});
    	...
    	newLoanButton.addActionListener(new ActionListener()
    	{
    		public void actionPerformed(ActionEvent ae)
    		{
    			newLoanButtonActionPerformed(ae);
    		}
    	});
    	...
    	monthsButton.addActionListener(new ActionListener()
    	{
    		public void actionPerformed(ActionEvent ae)
    		{
    			monthsButtonActionPerformed(ae);
    		}
    	});
    	...
    	paymentButton.addActionListener(new ActionListener()
    	{
    		public void actionPerformed(ActionEvent ae)
    		{
    			paymentButtonActionPerformed(ae);
    		}
    	});
    ...
    private void exitForm(WindowEvent we)
    {
    	System.exit(0);
    }
    private void computeButtonActionPerformed(ActionEvent ae)
    {
    	...
    	else
    	{
    		if(validateDecimalNumber(paymentTextField))
    		{
    			...
    			{
    				if(JOptionPane.showConfirmDialog(null,"Minimum payment must be $"+new DecimalFormat("0.00").format((int)(balance*monthlyInterest+1.0))+"\n"+"Do you want to use he minimum payment?","Ïnput Error",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE)==JOptionPane.YES_OPTION)
    				{
    	...
    	analysisTextArea.append("\n"+"Interser Rate:"+new DecimalFormat("0.00").format(interest)+"%");
    	loanBalance=balance;
    ...
    private void newLoanButtonActionPerformed(ActionEvent ae)
    {
    	if(computePayment)
    	{
    ...
    private void monthsButtonActionPerformed(ActionEvent ae)
    {
    ...
    private void paymentButtonActionPerformed(ActionEvent ae)
    {
    	computePayment=true;
	...
	private void balanceTextFieldActionPerformed(ActionEvent ae)
	{
		balanceTextField.transferFocus();
	}
	private void interestTextFieldActionPerformed(ActionEvent ae)
	{
		interestTextField.transferFocus();
	}
	private void paymentTextFieldActionPerformed(ActionEvent ae)
	{
		paymentTextField.transferFocus();
	}
	private void monthsTextFieldActionPerformed(ActionEvent ae)
	{
